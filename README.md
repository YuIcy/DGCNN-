...
#### Standard new model:
Notice that due to the edge cutting, the k need to be twice of base 20
``` 
python main_semseg_s3dis.py --test_area=5 --use_sgd=1 --model=dgcnn++ --k=40
```
#### Only with attention:
``` 
python main_semseg_s3dis.py --test_area=5 --use_sgd=1 --model=dgcnn++ --k=40 --ablation_mode=atten_only
```
#### Only with gating:
``` 
python main_semseg_s3dis.py --test_area=5 --use_sgd=1 --model=dgcnn++ --k=40 --ablation_mode=gating_only
```
