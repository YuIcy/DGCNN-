...
def train(args, io):
    ...
    for epoch in range(args.epochs):
        ...
        writer.add_scalar('Accuracy/Train_Avg_Class', train_avg_acc, epoch)
        ...
        writer.add_scalar('Accuracy/Test_Overall', test_acc, epoch)
        writer.add_scalar('Accuracy/Test_Avg_Class', test_avg_acc, epoch)
        writer.add_scalar('mIoU/Test', avg_test_iou, epoch)
